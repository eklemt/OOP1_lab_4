...
// TODO gemeinsamkeiten für alle typen festhalten, bspw. arraykeys hier anlegen
class Literaturtyp
{
    // Exemplarvariablen
    ...
    */
     ...
     */
    public Literaturtyp(String buchautor, String buchtitel)
    {
     ...
     */
    public Literaturtyp(String buchautor, String buchtitel, int jahr)
    {
        author = buchautor;
        title = buchtitel;
    ...
    public Literaturtyp(JSONObject jsonObject)  {
